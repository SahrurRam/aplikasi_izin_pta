        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="../libs/images/logo-pta.png" alt="brand" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>Pengadilan Tinggi Agama Makassar</strong></div>
							...
							<ul class="nav nav-second-level">
								<?php
									...
									if($pagedesc == "Menunggu Approval") {
										echo '<li><a href="cuti_waitapp.php" class="active">Menunggu Persetujaun</a></li>';
									}
									else {
